$(function () {
  ...
  // multiple action
  const btnRequestOperations = document.querySelectorAll('.btn-request-operation')
  btnRequestOperations.forEach(btnRequestOperation => {
    btnRequestOperation.addEventListener('click', e => {
      e.preventDefault()

      const inputIds = document.querySelectorAll('.request-selection:checked')
