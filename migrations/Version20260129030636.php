 ...
 */
final class Version20260129030636 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649CC22AD4 FOREIGN KEY (clinic_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
